...
@section('content')
    ...
    >
        <div class="flex items-center justify-between mb-4">
            <h1 class="text-2xl font-semibold text-brand-dark">Categorias</h1>
                ...
                <tbody class="divide-y divide-stone-200">
                    @forelse ($categories as $category)
                        <tr>
                            ...
                            <td class="px-4 py-3">
                                <span class="inline-flex rounded-full px-2 py-1 text-xs font-medium {{ $category->active ? 'bg-green-100 text-green-800' : 'bg-stone-200 text-stone-600' }}">
                            ...
                            <td class="px-4 py-3">
                                <button
                                    type="button"
                                    @click="editing = @json($category); modalOpen = true"
        ...
        >
            <div class="w-full max-w-sm bg-brand-paper rounded-lg shadow p-6" @click.outside="modalOpen = false">
                <h2 class="text-lg font-semibold text-brand-dark mb-4" x-text="editing ? 'Editar categoria' : 'Nova categoria'"></h2>
